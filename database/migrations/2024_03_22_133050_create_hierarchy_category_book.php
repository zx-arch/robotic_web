...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $data = [
            ...
            ['name' => 'Dasar', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Dasar', 'parent_id' => 28, 'language_id' => 67],
            ['name' => 'Menengah', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Menengah', 'parent_id' => 28, 'language_id' => 67],
            ['name' => 'Lanjutan', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Lanjutan', 'parent_id' => 28, 'language_id' => 67],
            ['name' => 'Membuat Pertunjukan Cahaya', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Dasar > Membuat Pertunjukan Cahaya', 'parent_id' => 29, 'language_id' => 67],
            ['name' => 'Membuat Mobil Robot', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Dasar > Membuat Mobil Robot', 'parent_id' => 29, 'language_id' => 67],
            ['name' => 'AI Programming', 'hierarchy_name' => 'AI Programming', 'parent_id' => 0, 'language_id' => 67],
            ['name' => 'Getting Started With AI_JE', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Getting Started With AI_JE', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Talking to Robots_JE', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Talking to Robots_JE', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Seeing with AI', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Seeing with AI', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Sorting the Garbage', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Sorting the Garbage', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Smarter Cars', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Smarter Cars', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Rock, Paper, Scissors', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Rock, Paper, Scissors', 'parent_id' => 35, 'language_id' => 67],
            ['name' => 'Robotic Companions', 'hierarchy_name' => 'Pemrograman Berbasis Blok > Robotic Companions', 'parent_id' => 35, 'language_id' => 67],
        ];
